...
// Everything must go through this module. Global PahoMQTT module
// only has a single public function, client, which returns
// a PahoMQTT client object given connection details.
 ...
 * <dl>
 * <dt><b>{@link PahoMQTT.Client}</b></dt>
 * <dd>This contains methods that provide the functionality of the API,
 * including provision of callbacks that notify the application when a message
 * arrives from or is delivered to the messaging server,
 * or when the status of its connection to the messaging server changes.</dd>
 * <dt><b>{@link PahoMQTT.Message}</b></dt>
...
//            break;
   ...
   *
   * @name PahoMQTT.ClientImpl @constructor
  ...
  var ClientImpl = function (uri, host, port, path, clientId) {
    ...
    this._trace("PahoMQTT.Client", uri, host, port, path, clientId);
  ...
  /**
   * The JavaScript application communicates to the server using a {@link PahoMQTT.Client} object.
   * <p>
   ...
   * that are defined on the {@link PahoMQTT.Client} object.
   * These may get called multiple times, and aren't directly related to specific method invocations made by the client.
   *
   * @name PahoMQTT.Client
   *
   * @constructor
   *
   ...
   *                            <ol>
   *                            <li>{@link PahoMQTT.Message} that was delivered.
   *                            </ol>
   * @property {function} onMessageArrived - called when a message has arrived in this PahoMQTT.client.
   *                            Parameters passed to the onMessageArrived callback are:
   *                            <ol>
   *                            <li>{@link PahoMQTT.Message} that has arrived.
   *                            </ol>
  ...
  var Client = function (host, port, path, clientId) {
     ...
     * @param {PahoMQTT.Message} connectOptions.willMessage - sent by the server when the client
     ...
     *
     * @name PahoMQTT.Client#subscribe
     * @function
     ...
     *
     * @name PahoMQTT.Client#unsubscribe
     * @function
     * @param {string} filter - describing the destinations to receive messages from.
     ...
     *
     * @name PahoMQTT.Client#send
     * @function
     * @param {string|PahoMQTT.Message} topic - <b>mandatory</b> The name of the destination to which the message is to be sent.
     *             - If it is the only parameter, used as PahoMQTT.Message object.
     ...
     * Synonym for PahoMQTT.Client#send
     *
     * @name PahoMQTT.Client#publish
     * @function
     * @param {string|PahoMQTT.Message} topic - <b>mandatory</b> The name of the topic to which the message is to be published.
     *             - If it is the only parameter, used as PahoMQTT.Message object.
     ...
     *
     * @name PahoMQTT.Client#disconnect
     * @function
     ...
     *
     * @name PahoMQTT.Client#getTraceLog
     * @function
     ...
     * Start tracing.
     *
     * @name PahoMQTT.Client#startTrace
     * @function
     */
     ...
     * Stop tracing.
     *
     * @name PahoMQTT.Client#stopTrace
     * @function
     */
