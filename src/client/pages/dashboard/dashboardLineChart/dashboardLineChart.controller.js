...
export default function DashboardLineChartCtrl(baConfig, layoutPaths, baUtil) {
    'ngInject';

    //console.log('[DashboardLineChartCtrl] baConfig.colors=', baConfig.colors);

  var layoutColors = baConfig.colors;
  var graphColor = baConfig.theme.EClient ? '#000000' : layoutColors.primary;
  var chartData = [{
